        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src="/assests/images/hotel-new.jpg" alt="zikhron Hotel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="zikhron-color">Zikhron Rest</span>
                        </h1><br />
                        <h4>Step into a haven in Galle</h4>
                    </div>
                </header>
            </section>
            ...
            <h2 className="home-services">Services at <span className="zikhron-color">Zikhron Hotel</span></h2>
